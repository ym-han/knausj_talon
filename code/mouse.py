...
def on_pop(active):
    print(f"setting_mouse_enable_pop_stops_scroll is {setting_mouse_enable_pop_stops_scroll.get()}")
    #setting_mouse_enable_pop_stops_scroll.get() >= 1 and 
    #YM: commented out b/c wasn't getting thei rght setting
